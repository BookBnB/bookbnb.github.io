...
<iframe src="https://adoptame.storiesonboard.com/m/dP3lBB9Tsk6c55ZngfF-Iw" frameBorder="0" allowFullScreen
...
Para validar rápidamente lo que se iba a construir durante las iteraciones realizamos prototipos de las distintas funcionalidades del sistema. Para ello inicialmente escogimos la herramienta [Balsamiq](https://balsamiq.com/) y luego utilizamos [Figma](https://www.figma.com/) las cuales nos permitieron colaborar en la construcción de los prototipos de forma online.
...
<img alt="Prototipo lista reservas" src={baseUrl('img/analisis/prototipo_lista_reservas.png')} style={{margin: '15px auto', display: 'flex'}}/>
<img alt="Prototipo lista reservas" src={baseUrl('img/analisis/prototipo_calificar.png')} style={{margin: '15px auto', display: 'flex'}}/>

Los otros prototipos pueden consultarse en el [proyecto Balsamiq](https://drive.google.com/file/d/1O-LUuy7DgqDc9DJCaq1L3u9cbBKi0PsV/view?usp=sharing) o en el [proyecto Figma](https://www.figma.com/file/4N4LYOk113yWzLpYpiSYc4/BookBnB?node-id=108%3A228).
